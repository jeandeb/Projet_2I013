...
#team2.add( "Defence", strategy.Defence4Strategy( ) )
...
team2.add( "Defence", strategy.SoloStrategy( ) )
#team1.add( "Barthez", strategy.GoalStrategy( ) )
#team1.add( "Defenseur", strategy.Defence4Strategy( ) ) 
#team1.add( "Striker", strategy.Striker4Strategy( ) )
